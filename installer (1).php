...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Boris_Bar20221208_treetravel_ebe7685c226771071840_20221208192453_archive.zip';
        const ARCHIVE_SIZE       = '75803180';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'ebe7685-08192453';
        const SECONDARY_PACKAGE_HASH = '0e260fb-08192453';
        const VERSION            = '1.5.1';
